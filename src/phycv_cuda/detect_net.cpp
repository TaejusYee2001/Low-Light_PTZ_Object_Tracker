...
: m_width(width), m_height(height), m_num_detections(0), m_box_left(0), m_box_top(0), m_box_right(0), m_box_bottom(0), d_image(image), m_net(nullptr)
{}

void DetectNet::create()
{
    m_net = detectNet::Create("facedetect", 0.4); 
